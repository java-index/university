...
<spring:eval 
	expression="student.photo == null ? '../resources/images/person/noname-image.jpg' : '../students/photo/${student.id}'" 
	var="logoImage" />
	...
	<div class="container">
		...
		<form:form modelAttribute="student" id="studentUpdateForm"
			...
			<div class="row">
				...
				<div class="col-sm-offset-2 col-sm-2">
					<div class="form-group">
						<img id="preview" src="${logoImage}" width="200" onclick="setPhoto()" class="img-thumbnail">
					</div>
			...
			<div class="form-group ${errors['firstName']}">
				<form:label path="firstName" cssClass="control-label col-sm-4">${labelFirstName}:</form:label>
				<div class="col-sm-8">
					<form:input path="firstName" cssClass="form-control" maxlength="55"
						aria-describedby="firstName.errors" required="true" />
					<form:errors id="firstName.errors" path="firstName" cssClass="help-block" />
				</div>
			</div>

			<div class="form-group ${errors['lastName']}">
				<form:label path="lastName" cssClass="control-label col-sm-4">${labelLastName}:</form:label>
				<div class="col-sm-8">
					<form:input path="lastName" cssClass="form-control" maxlength="55" 
					aria-describedby="lastName.errors" required="true" />
					<form:errors id="lastName.errors" path="lastName" cssClass="help-block" />
				</div>
			</div>

			<div class="form-group ${errors['birthDate']}">
				<form:label path="birthDate" cssClass="control-label col-sm-4">${labelBirthDate}:</form:label>
				<div class="col-sm-8">
			...
			<div class="form-group ${errors['sex']}">
				<form:label path="sex" cssClass="control-label col-sm-4">${labelGender}:</form:label>
				<div class="col-sm-8">
			...
			<div class="form-group ${errors['tel']}">
				<form:label path="tel" cssClass="control-label col-sm-4">${labelTel}:</form:label>
				<div class="col-sm-8">
			...
			<div class="form-group ${errors['note']}">
				<form:label path="note" cssClass="control-label col-sm-4">${labelNote}:</form:label>
				<div class="col-sm-8">
